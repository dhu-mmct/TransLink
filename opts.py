...
class opts:
    def __init__(self):
        ...
        self.parser.add_argument(
            '--root_dataset',
            default='/home/shuanghong/Downloads/github/dataset'
        )
        self.parser.add_argument(
            '--path_AFLink',
            default='/home/shuanghong/Downloads/github/project/strongsortPure/data_space/AFLink_epoch20.pth'
        )
        self.parser.add_argument(
            '--dir_save',
            default='/home/shuanghong/Downloads/github/project/strongsortPure/results'
        )
        self.parser.add_argument(
            '--EMA_alpha',
            default=0.9
    ...
    def parse(self, args=''):
        ...
        if opt.BoT:
            ...
            opt.dir_dets = '/home/shuanghong/Downloads/github/project/strongsortPure/data_space/{}_{}_YOLOX+BoT'.format(opt.dataset, opt.mode)
        else:
        ...
        if opt.EMA:
            ...
            opt.nn_budget = 100
        if opt.ECC:
            path_ECC = '/home/shuanghong/Downloads/github/project/strongsortPure/data_space/{}_ECC_{}.json'.format(opt.dataset, opt.mode)
